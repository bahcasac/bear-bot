                                    ...
                                    callback: function(response, convo) {
                                        ...
                                        if(due) {
                                            ...
                                            controller.storage.channels.get(room.id, function (err, room) {
                                                if (room) {
                                                    room.details.event[idx]= {name: name, description: description, time: time};
                                            ...
                                            controller.storage.channels.get(room.id, function (err, room) {
                                                if (room) {
                                                    ...
                                                    if(!room.details.event) room.details.event = [];

                                                    room.details.event.push({name: name, description: description, time: time});
